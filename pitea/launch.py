...
from interfaz.comandos.IntercambioQSLCommand import IntercambioQSLCommand
...
class Launch :
    ...
    def menu():
        ...
        comandos = [OcultarArchivoCommand(), DesocultarArchivoCommand(), GenerarTarjetaCommand(),IntercambioQSLCommand()]
