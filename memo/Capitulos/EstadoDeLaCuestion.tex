...
En la tabla~\ref{tab:SSTVBandas} se pueden observar las frecuencias más usadas por radioaficionados para transmisión por SSTV, significando LSB, \textit{Lower Side Band} y USB, \textit{Upper Side Band}.
...
\begin{table}[h]
	...
	\begin{tabular}{c|c|c}
		...
		\hline\hline
		80 m  & \SI{3730 \pm 5}{\kilo\hertz}                 & LSB \\
		40 m  & \SIrange{7043.5}{7050}{\kilo\hertz}         & LSB \\
