...
%No es el mejor apaño para que separe bién steganography pero por ahora funciona
\tituloPortadaEng{%
  \selectlanguage{english} IPAST: Information Protection through Acoustic Ste\-ga\-no\-gra\-phy Techniques \selectlanguage{spanish}
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\autorPortada{Alberto Martín Oruña Nota: 10\\Rodrigo Gallego Marín Nota: 10}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\directorPortada{José Luis Vázquez Poletti\\
...
% Si se fuerza un subtítulo distinto, no hace falta definirlo.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\colaboradorPortadaVal}{}  % Define vacío si no hay colaboradores
